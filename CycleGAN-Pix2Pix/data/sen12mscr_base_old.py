...
class SEN12MSCRBase(Dataset, ABC): # A : SAR / B : EO
    def __init__(self, root, split="all", region='all', season='all', rescale_method='default', s1_rgb_composite='add', Lambda=None):
...
class SEN12MSCR_AB(SEN12MSCRBase, ABC): # A : SAR / B : EO
    def __init__(self, root, split="all", region='all', season='all', rescale_method='default', s1_rgb_composite='add', Lambda=None):
        SEN12MSCRBase.__init__(root, split, region, season, rescale_method, s1_rgb_composite, Lambda)
