...
class AlignedSPADEDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        transform_image = get_transform(self.opt, params, use_hsv_aug=self.opt.use_hsv_aug, use_gray_aug=self.opt.use_gray_aug, use_gaussian_blur=self.opt.use_gaussian_blur, kernel_size=self.opt.kernel_size, rescale_method=self.opt.s2_rescale_method)
